...
public class ProductServiceImplementation implements ProductService{
    ...
    public Page<Product> getAllProduct(String category, List<String> colors, List<String> sizes, Integer minPrice, Integer maxPrice, Integer minDiscount, String sort, String stock, Integer pageNumber, Integer pageSize) {
        ...
        // Pass minDiscount directly. Assumes productRepository.filterProducts handles null for Integer.
        List<Product> products = productRepository.filterProducts(category, minPrice, maxPrice, minDiscount, sort);

        // Apply colors filter only if 'colors' list is not null and not empty
        ...
        // Apply sizes filter if needed (currently not implemented, but structure would be similar)
        ...
        // Apply stock filter independently
        if (stock != null) {
            ...
            // Add other stock values if needed (e.g., "all")
        }
